package com.acaikeji.rocket_mq_demo.config;

import javax.annotation.PostConstruct;

import com.acaikeji.rocket_mq_demo.event.MessageEvent;
import com.acaikeji.rocket_mq_demo.properties.RocketMQProperties;
...
public class RocketMQConfiguration {
    ...
    public DefaultMQProducer defaultProducer() throws MQClientException {
        ...
        producer.start();
        log.info("rocket-mq producer default-server is starting....");
        return producer;
    }
    ...
    public TransactionMQProducer transactionProducer() throws MQClientException {
        ...
        producer.start();
        log.info("rocke-tmq transaction producer server is starting....");
        return producer;
    }
